...
def get_space_distance(a, b, grid_length=0.5, num_samples=20):
    a_pos = sample_normed_pos(a,num_samples, grid_length=grid_length)
    b_pos = sample_normed_pos(b,num_samples, grid_length=grid_length)
