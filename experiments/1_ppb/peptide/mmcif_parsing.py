...
import peptide.residue_constants as residue_constants
from peptide.openfold_error import MultipleChainsError
    ...
    try:
        ...
        for chain_id, seq_info in valid_chains.items():
            ...
            for monomer in seq_info:
                code = IUPACData.protein_letters_3to1.get(monomer.id.capitalize(), "X")
